...
(function() {
  ...
  ContentEdit.ResizableElement = (function(_super) {
    ...
    ResizableElement.prototype.size = function(newSize) {
      var height, maxSize, minSize, width, metric;
      if (!newSize) {
          width = /^\d+$/.test(this.attr('width')) ? this.attr('width') + 'px' : this.attr('width');
          height = /^\d+$/.test(this.attr('height')) ? this.attr('height') + 'px' : this.attr('height');
          return [width, height];
      }
  ...
  ContentEdit.Image = (function(_super) {
    ...
    Image.prototype.mount = function() {
      ...
      if (this._attributes['width']) {
          metric = /^\d+$/.test(this._attributes['width']) ? 'px' : '';
          style += "width:" + this._attributes['width'] + metric + ";";
      }
      if (this._attributes['height']) {
          metric = /^\d+$/.test(this._attributes['height']) ? 'px' : '';
          style += "height:" + this._attributes['height'] + metric + ";";
      }
